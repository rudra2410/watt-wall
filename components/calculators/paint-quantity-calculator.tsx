...
export function PaintQuantityCalculator() {
  ...
  return (
    <section aria-labelledby="paint-input-title" className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(20rem,0.82fr)] lg:items-start">
      ...
      <section aria-labelledby="paint-result-title" className="rounded-xl border border-primary/20 bg-primary/10 p-5 shadow-sm sm:p-7 lg:sticky lg:top-6">
