...
const metadataDescription = "Learn what dehumidifier IEF measures, then estimate electricity cost from watts, runtime, duty cycle, measured kWh, and your local rate.";
export const metadata = createPageMetadata({ title: "Dehumidifier IEF and Electricity Cost", description: metadataDescription, path });
...
<p>If a monitor records 3.2 kWh over 24 hours, divide by one day and use 3.2 kWh/day. A 30-day projection would be 96 kWh. The measured result already includes cycling, so enter a full 24-hour period at 100% duty when converting it to an average watt value. Do not apply a second duty reduction.</p>
</TrustSection>
...
<TrustSection title="Use cost only after energy is documented">
<p>Apply your local variable price per kWh after calculating or measuring energy. A different price changes the cost, not the kWh or the amount of water removed. The estimate excludes fixed charges, taxes, time-of-use prices and the value of the water removed. It also does not turn IEF into an annual cost.</p>
