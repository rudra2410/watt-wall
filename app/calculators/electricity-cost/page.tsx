      ...
      <article className="mt-14 grid gap-10 rounded-2xl bg-card-section p-5 sm:mt-16 sm:p-8 lg:p-10 xl:grid-cols-[minmax(0,1.1fr)_minmax(18rem,0.9fr)] xl:gap-12">
        <div className="space-y-12">
          ...
          <section aria-labelledby="electricity-faq-title">
            ...
            <FaqAccordion className="mt-6 border-y border-border" items={electricityCostFaqs} />
          </section>
        </div>

        <aside className="space-y-5" aria-label="Assumptions, sources, and related calculators">
          <section className="rounded-xl bg-card p-5 shadow-sm sm:p-6" aria-labelledby="electricity-assumptions-title">
          ...
          <nav className="rounded-xl bg-card p-5 shadow-sm sm:p-6" aria-labelledby="related-calculators-title">
