...
export default function TermsPage() {
  return (
    <TrustPageShell category="Site terms" path="/terms" title="Terms of Use" description="These plain-language terms explain the intended use and limits of the Watt & Wall website and calculators.">
      <TrustNote><strong>Effective date: September 26, 2026.</strong> These terms describe the current public website, including its analytics and advertising code. They are plain-language product information, not jurisdiction-specific legal advice.</TrustNote>
